...
<svg xmlns="http://www.w3.org/2000/svg" class="d-none">
    ...
    <symbol id="buy" viewBox="0 0 16 16">
...
<body>
  <div class="container">
    <header class="d-flex flex-wrap align-items-center justify-content-center justify-content-between py-2 mb-2">
      ...
      <a href="/" class="d-flex align-items-center justify-content-center mb-2 text-dark text-decoration-none">
        <span class="fs-4 mx-3">Gabaldi MensWear</span>
      </a>
